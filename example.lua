...
local autofarm = win.CreateButton("AutoFarm","16927814188")
win.CreateElement("Button",autofarm,"Test button")
win.CreateElement("Toggle",autofarm,"Toggle")
win.CreateElement("Label",autofarm,"This is a text label")
